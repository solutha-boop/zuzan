...
git -c user.email="dev@solutha.co.za" -c user.name="ZuZan Dev" commit -m "feat: SMT integration endpoint POST /integrations/invoice, payroll_enabled fix, financial year end + CIPC AR deadline [%STAMP%]" --allow-empty
