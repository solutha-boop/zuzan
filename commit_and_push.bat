...
git -c user.email="dev@solutha.co.za" -c user.name="ZuZan Dev" commit -m "feat: accountant multi-client — CompanyMembership, client picker, company switcher [%STAMP%]" --allow-empty
