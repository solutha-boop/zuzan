...
git -c user.email="dev@solutha.co.za" -c user.name="ZuZan Dev" commit -m "fix: billing bugs — adhoc_charge NameError, AFS decrypt, daily charges loop + PayFast UI warnings [%STAMP%]" --allow-empty
