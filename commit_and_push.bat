...
git -c user.email="dev@solutha.co.za" -c user.name="ZuZan Dev" commit -m "fix: NBCPSS modal — area rates update on select, salaried employees show gross, Sunday hrs = hours worked [%STAMP%]" --allow-empty
