...
git -c user.email="dev@solutha.co.za" -c user.name="ZuZan Dev" commit -m "feat: employee import template — banking, tax no, DOB, job title, employment date + sample row [%STAMP%]" --allow-empty
