...
git -c user.email="dev@solutha.co.za" -c user.name="ZuZan Dev" commit -m "feat: accountant multi-client — sync-customers shortcut, SMT integration, payroll fix, CIPC AR deadline [%STAMP%]" --allow-empty
