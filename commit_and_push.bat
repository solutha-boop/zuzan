...
git -c user.email="dev@solutha.co.za" -c user.name="ZuZan Dev" commit -m "feat: add client — POST /companies/create-new, Add Client button in picker + sidebar [%STAMP%]" --allow-empty
